...
import draft from './assets/green.png'
    ...
    <Box >
      <Paper sx={{ mx: 2, p: 2, minHeight: '120vh' }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',mb:5 }} >
          ...
          <Box sx={{mb:5}}> 
            <Typography sx={{ display: 'flex' , alignItems: 'center', gap: '10px', py: '12px',}}> <img src={draft} alt="green.png" /><Typography color="#00A218" fontWeight={'bold'} fontSize={'15px'} >AUTO RESPONDED</Typography>  </Typography>
